...
public class Note : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            transform.localPosition = Vector3.Lerp(Vector3.forward * MusicManager.Instance.NoteSpawnZ, Vector3.forward * MusicManager.Instance.Player.transform.position.z, t * 100);
        }
    }
}
