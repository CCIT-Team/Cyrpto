...
Shader "AE/Information_Board_LWRP_2019.3+"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_cast_1 = (frac( ( _Speed * ( _TimeParameters.x ) ) )).xxxx;
				...
				float3 Emission = ( lerpResult16 * _Emmisive_Power ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
...
/*ASEBEGIN
Version=18000
357;169;1532;802;482.4411;423.7245;1.520417;True;False
Node;AmplifyShaderEditor.RangedFloatNode;11;-1074.915,-85.40617;Inherit;False;Property;_Speed;Speed;3;0;Create;True;0;0;False;0;2.57;2.57;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;17;-170.1846,408.9912;Inherit;True;Property;_Emissive;Emissive;1;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;25;-256.151,-206.5866;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;False;0;0.8018868,0.1626469,0.1626469,0;0.8018868,0.1626469,0.1626469,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8FA174278D350BEE647B182BA59A45E108A0297F